...
import juguete1 from '../images/juguete 1.webp';
import juguete2 from '../images/juguete 2.jpg';
import juguete3 from '../images/juguete 3.webp';
import juguete4 from '../images/juguete 4.webp';
import juguete5 from '../images/juguete 5.webp';
import juguete6 from '../images/juguete 6.webp';
...
const ComidaData = [
    ...
    { id:8,name: "Dog Chow",                      peso: "2KG", image: comida8 ,    tipo:"Pequeño",raza: 'Mediana',linea:'Standard',info:'Encuentras una alimentación completa para tu mascota, para más años de vida juntos.'},
    {id:9,name: "Cuerda Para Morder", image: juguete1},
    {id:9,name: "Cuerda Para Morder", image: juguete2},
    {id:9,name: "Cuerda Para Morder", image:juguete3},
    {id:9,name: "Cuerda Para Morder", image: juguete4},
    {id:9,name: "Cuerda Para Morder", image: juguete5 },
    {id:9,name: "Cuerda Para Morder", image: juguete6},
];
export default ComidaData;